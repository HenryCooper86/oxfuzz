...
use hf_core::tool::{Tool, ToolCategory, ToolDefinition, ToolError, ToolIndexEntry, ToolRegistry};
...
impl Tool for ToolRef {
    async fn execute(
        &self,
        input: hf_core::tool::ToolInput,
    ) -> Result<hf_core::tool::ToolOutput, ToolError> {
...
mod tests {
    ...
    use hf_core::tool::{ToolInput, ToolOutput, ToolType};
