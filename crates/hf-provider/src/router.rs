...
use hf_core::provider::{LlmProvider, ProviderError, RoutePriority, RouteRequest};
...
mod tests {
    ...
    impl MockProvider {
        fn new(id: &str, model: &str, tags: Vec<&str>) -> Self {
            Self {
                meta: ProviderMetadata {
                    id: hf_core::types::ProviderId::from_string(id),
    ...
    fn test_routing_preferred_provider_bypasses_freeze() {
        ...
        let route = RouteRequest {
            preferred_provider_id: Some(hf_core::types::ProviderId::from_string("p1")),
            ..Default::default()
        };
