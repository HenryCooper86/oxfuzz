...
pub use model::{
    ...
    CapabilityRequest, CaptureAnalysisResult, MessageDirection, ModeConfig, MutationRequest,
    MutationResult, OperationLimits, ProtocolMessage, ReplayAction, ReplayPlan, ReplayPlanRequest,
    ReplayRequest, ReplayResult, ReplayStep, ResponseEnvelope, SchemaEnvelope, TranscriptEvent,
};
