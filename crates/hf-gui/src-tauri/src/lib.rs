...
use commands::{
    ...
    corpus_seed, coverage_functions, create_session, delete_agent, delete_report_draft,
    delete_skill, diagnostics_cost_summary, discover, dismiss_interrupted_run, ensure_docker,
    generate_report, generate_seeds, get_agent, get_providers, gitlab_issue_export,
