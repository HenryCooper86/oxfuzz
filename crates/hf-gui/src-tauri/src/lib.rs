...
use commands::{
    ...
    automotive_lab_plan, automotive_lab_reset, automotive_lab_simulate, automotive_live_monitor,
    automotive_scan_uds, build_diagnose, build_history, build_profile, build_profile_clear,
    build_profile_set, build_run, campaign_advice, campaign_evidence, cancel_run, change_compare,
    change_impact, change_publish, chat_agent, chat_answer_permission, chat_branch, chat_branches,
    chat_checkpoints, chat_history, chat_rollback, chat_rollback_to, clear_all_artifacts,
    clear_all_runs, clear_knowledge, clear_project_auto_revert_override, clear_workspace,
    config_toml_to_value, config_value_to_toml, corpus_capabilities, corpus_grow, corpus_import,
    corpus_list, corpus_minimize, corpus_prune, corpus_prune_coverage, corpus_seed,
    coverage_blockers, coverage_functions, create_remediation_operation, create_session,
    defectdojo_configured, defectdojo_embed, defectdojo_embed_close, defectdojo_embed_reload,
    defectdojo_start, defectdojo_status, defectdojo_stop, defectdojo_test_connection, delete_agent,
    ...
    export_remediation_draft, export_report, export_repro, file_issue,
    finding_proof_card_for_crash, finding_review, finding_review_queue, generate_automotive_report,
    generate_report, generate_seeds, generate_seeds_llm, get_automotive_settings,
    get_defectdojo_config, get_fuzzing_settings, get_issue_tracker_config, get_providers,
    harness_compile, harness_draft, harness_promote, harness_promote_with_findings,
    harness_review_queue, harness_smoke, harness_tournament, host_arch, initialize_provider,
    interrupted_runs, issue_export, issue_tracker_test_connection, knowledge_index,
    knowledge_ingest, knowledge_search, knowledge_stats, knowledge_summary, list_agents,
    list_automotive_operations, list_automotive_state_corpus, list_models, list_report_drafts,
    list_skills, open_defectdojo, open_file_dialog, open_folder_dialog, open_path, open_url,
    oracle_scaffold, oracle_violation, patch_defectdojo_config, patch_issue_tracker_config,
    policy_decisions, project_auto_revert_override, project_auto_revert_overrides,
    promote_automotive_state_artifact, provider_test, push_to_defectdojo, read_config, read_skill,
    remediation_operation, report_formats, reveal_path, revert_harness_from_run, run_comparison,
    run_coverage_series, run_fuzzer, run_harness_source, run_history, run_owner, run_syzkaller,
    save_agent, save_report_draft, save_skill, schedule_concurrency_limits,
    schedule_concurrency_set, schedule_create, schedule_delete, schedule_history,
    schedule_history_clear, schedule_list, schedule_recovery_acknowledge, schedule_recovery_list,
    schedule_runtime, schedule_set_enabled, schedule_targets, seed_survival, semgrep_available,
    set_automotive_settings, set_project_auto_revert_override, set_providers, setup_providers,
    setup_readiness, start_remediation_verification, system_snapshot, system_status_cmd, triage,
