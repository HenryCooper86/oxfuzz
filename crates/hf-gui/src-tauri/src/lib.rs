...
use commands::{
    ...
    automotive_lab_plan, automotive_live_monitor, automotive_scan_uds, build_diagnose, build_run,
    campaign_advice, campaign_evidence, cancel_run, change_compare, change_impact, change_publish,
    ...
    config_value_to_toml, corpus_grow, corpus_list, corpus_prune, corpus_seed, coverage_blockers,
    coverage_functions, create_remediation_operation, create_session, defectdojo_configured,
    ...
    finding_proof_card_for_crash, generate_automotive_report, generate_report, generate_seeds,
    generate_seeds_llm, get_automotive_settings, get_defectdojo_config, get_fuzzing_settings,
    get_issue_tracker_config, get_providers, harness_compile, harness_draft, harness_promote,
    harness_promote_with_findings, harness_review_queue, harness_smoke, harness_tournament,
    host_arch, interrupted_runs, issue_export, issue_tracker_test_connection, knowledge_index,
    knowledge_ingest, knowledge_search, knowledge_stats, knowledge_summary, list_agents,
    list_automotive_operations, list_models, list_report_drafts, list_skills, open_defectdojo,
