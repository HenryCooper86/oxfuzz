...
use commands::{
    ...
    generate_seeds, get_agent, get_providers, gitlab_issue_export, harness_compile, harness_draft,
    harness_review_queue, host_arch, interrupted_runs, knowledge_index, knowledge_ingest,
    knowledge_search, knowledge_summary, list_agents, list_configs, list_models, list_skills,
    open_file_dialog, open_folder_dialog, provider_statuses, provider_test, read_config,
    read_skill, run_fuzzer, run_syzkaller, save_agent, save_report, save_skill, schedule_create,
