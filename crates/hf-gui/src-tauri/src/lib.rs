...
use commands::{
    ...
    automotive_capabilities, automotive_execute_replay, automotive_generate_mutations, cancel_run,
    chat_agent, chat_answer_permission, chat_branch, chat_branches, chat_checkpoints, chat_history,
    chat_rollback, chat_rollback_to, chat_send, clear_all_artifacts, clear_all_runs,
    clear_knowledge, clear_project_auto_revert_override, clear_workspace, config_toml_to_value,
    ...
    export_markdown, export_project_data, export_report, file_issue, generate_report,
    generate_seeds, generate_seeds_llm, get_agent, get_automotive_settings, get_defectdojo_config,
    ...
    interrupted_runs, issue_export, issue_tracker_configured, issue_tracker_test_connection,
    knowledge_index, knowledge_ingest, knowledge_search, knowledge_summary, list_agents,
    list_automotive_operations, list_configs, list_models, list_report_drafts, list_skills,
    open_defectdojo, open_file_dialog, open_folder_dialog, open_path, open_url,
    patch_defectdojo_config, patch_issue_tracker_config, project_auto_revert_override,
    ...
    save_report, save_report_draft, save_skill, schedule_concurrency_get,
    schedule_concurrency_limits, schedule_concurrency_set, schedule_create, schedule_delete,
    schedule_history, schedule_history_clear, schedule_list, schedule_set_enabled,
    schedule_targets, set_automotive_settings, set_project_auto_revert_override, set_providers,
