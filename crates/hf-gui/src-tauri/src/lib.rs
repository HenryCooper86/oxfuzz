...
use commands::{
    ...
    automotive_scan_uds, build_diagnose, build_run, campaign_advice, campaign_evidence, cancel_run,
    change_compare, change_impact, change_publish, chat_agent, chat_answer_permission, chat_branch,
    chat_branches, chat_checkpoints, chat_history, chat_rollback, chat_rollback_to,
    clear_all_artifacts, clear_all_runs, clear_knowledge, clear_project_auto_revert_override,
    clear_workspace, config_toml_to_value, config_value_to_toml, corpus_capabilities, corpus_grow,
    corpus_import, corpus_list, corpus_minimize, corpus_prune, corpus_prune_coverage, corpus_seed,
