...
use commands::{
    ...
    chat_send, clear_knowledge, config_toml_to_value, config_value_to_toml, corpus_grow,
    corpus_list, corpus_prune, corpus_seed, coverage_functions, create_session, delete_agent,
    delete_skill, diagnostics_cost_summary, discover, dismiss_interrupted_run, ensure_docker,
    generate_report, generate_seeds, get_agent, get_providers, harness_compile, harness_draft,
    host_arch, interrupted_runs, knowledge_index, knowledge_search, knowledge_summary, list_agents,
    list_configs, list_models, list_skills, open_file_dialog, open_folder_dialog, provider_statuses,
    provider_test,
