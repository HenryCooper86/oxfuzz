...
use commands::{
    ...
    corpus_prune, corpus_seed, coverage_blockers, coverage_functions, create_remediation_operation,
    ...
    file_issue, finding_proof_card_for_crash, generate_automotive_report, generate_report,
    generate_seeds, generate_seeds_llm, get_automotive_settings, get_defectdojo_config,
    get_fuzzing_settings, get_issue_tracker_config, get_providers, harness_compile, harness_draft,
    harness_promote, harness_promote_with_findings, harness_review_queue, harness_smoke,
    harness_tournament, host_arch, interrupted_runs, issue_export, issue_tracker_test_connection,
    knowledge_index, knowledge_ingest, knowledge_search, knowledge_stats, knowledge_summary,
    list_agents, list_automotive_operations, list_automotive_state_corpus, list_models,
    list_report_drafts, list_skills, open_defectdojo, open_file_dialog, open_folder_dialog,
    open_path, open_url, oracle_scaffold, oracle_violation, patch_defectdojo_config,
    patch_issue_tracker_config, policy_decisions, project_auto_revert_override,
    project_auto_revert_overrides, promote_automotive_state_artifact, provider_test,
    push_to_defectdojo, read_config, read_skill, remediation_operation, report_formats,
    reveal_path, revert_harness_from_run, run_coverage_series, run_fuzzer, run_harness_source,
    run_history, run_syzkaller, save_agent, save_report_draft, save_skill,
    ...
    schedule_recovery_list, schedule_set_enabled, schedule_targets, semgrep_available,
    set_automotive_settings, set_project_auto_revert_override, set_providers,
