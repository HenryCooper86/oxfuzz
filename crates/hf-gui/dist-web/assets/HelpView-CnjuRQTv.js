import{u as k,r as u,j as e,V as S,B as g,L as E,o as p,G as C,S as x,d as R}from"./index-DRx7dcZO.js";import{M as A,r as D,c as j,a as T}from"./reportPreviewCode-DhyTMgmq.js";const I=[{id:"start",title:"Getting Started"},{id:"pipeline",title:"The Fuzzing Pipeline"},{id:"library",title:"Library & Resources"},{id:"config",title:"Configuration"},{id:"reference",title:"Reference"}],_=`
...
`,se=[{id:"welcome",group:"start",title:"Welcome & Safety Model",keywords:"intro overview what is fuzzing safe sandbox hitl",body:_},{id:"first-run",group:"start",title:"First Run & Setup",keywords:"wizard provider api key docker install onboarding getting started",body:L},{id:"pipeline",group:"start",title:"The Pipeline & Happy Path",keywords:"flow stages order discover harness run triage corpus workflow",body:P},{id:"dashboard",group:"pipeline",title:"Dashboard",keywords:"workbench overview readiness reports repro review health metrics",body:N},{id:"chat",group:"pipeline",title:"AI Assistant (Chat)",keywords:"agent conversation tools plan auto branches rollback model",body:H},{id:"workflow",group:"pipeline",title:"Fuzzing Workflow",keywords:"accordion connected flow one page stages",body:O},{id:"discover",group:"pipeline",title:"Discover Targets",keywords:"scan candidates ranking fit score reachability call graph c cpp",body:F},{id:"harness",group:"pipeline",title:"Generate Harness",keywords:"draft compile smoke approve promote seeds engine language rust",body:M},{id:"run",group:"pipeline",title:"Run the Fuzzer",keywords:"campaign engine duration syzkaller kernel edges execs stop coverage",body:G},{id:"triage",group:"pipeline",title:"Triage Crashes",keywords:"casr severity dedup stack signature bug report defectdojo export",body:W},{id:"corpus",group:"pipeline",title:"Manage the Corpus",keywords:"seed grow prune minimize inputs ai generate",body:U},{id:"projects",group:"library",title:"Projects",keywords:"recent add delete remove folder workspace",body:$},{id:"artifacts",group:"library",title:"Artifacts",keywords:"crashes corpus inputs browse export clear",body:B},{id:"reports",group:"library",title:"Reports",keywords:"composed markdown html pdf docx export preview",body:K},{id:"runs",group:"library",title:"Run History",keywords:"trends compare coverage curve auto-revert regression harness revision",body:V},{id:"audit",group:"library",title:"Policy Audit",keywords:"auto-revert events timeline reverted flagged",body:q},{id:"agents",group:"library",title:"Agents",keywords:"roles tools skills system prompt autonomy custom built-in",body:X},{id:"skills",group:"library",title:"Skills",keywords:"playbooks domain built-in custom root.md",body:Y},{id:"knowledge",group:"library",title:"Knowledge",keywords:"bm25 search index ingest documents pdf learned",body:J},{id:"automation",group:"library",title:"Automation",keywords:"schedule campaign cron interval headless promoted concurrency budget",body:Q},{id:"defectdojo",group:"library",title:"DefectDojo",keywords:"vulnerability management findings embed push integration",body:Z},{id:"settings",group:"config",title:"Settings",keywords:"providers runtime engines guardrails storage integrations issue tracker form raw toml",body:ee},{id:"shortcuts",group:"reference",title:"Keyboard Shortcuts",keywords:"hotkeys command palette cmd k ctrl",body:te},{id:"troubleshooting",group:"reference",title:"Troubleshooting",keywords:"errors problems docker provider gating messages fix help",body:oe},{id:"cli",group:"reference",title:"Command-Line Equivalent",keywords:"cli terminal hobot-fuzz commands serve tui",body:re},{id:"glossary",group:"reference",title:"Glossary",keywords:"definitions terms vocabulary meaning",body:ae}],ne=[{id:"start",title:"快速开始"},{id:"pipeline",title:"模糊测试流水线"},{id:"library",title:"库与资源"},{id:"config",title:"配置"},{id:"reference",title:"参考"}],ie=`
# 欢迎使用 hobot_fuzz

**hobot_fuzz 是一个 AI 模糊测试智能体。** 你把它指向一个代码库，它就会找出最值得
测试的函数，为它们编写测试代码，在安全的沙箱中运行真正的模糊测试引擎，并解释它发现
的任何缺陷——在关键步骤征求你的批准。
...
一——通常还需要大量专家工作。hobot_fuzz 将这项工作自动化。
...
- **人工介入(HITL)关卡。** 生成的测试桩源码会先由 LLM 分类定级步骤审查，*再*由你审
  查，之后才会被批准用于完整的测试活动。
- **未经批准绝不运行。** hobot_fuzz 绝不会在未经你明确批准的情况下在你的主机上运行生
  成的代码。
...
`,_e=[{id:"welcome",group:"start",title:"欢迎与安全模型",keywords:"简介 概述 什么是模糊测试 安全 沙箱 人工介入 hitl",body:ie},{id:"first-run",group:"start",title:"首次运行与设置",keywords:"向导 提供方 api 密钥 docker 安装 引导 快速开始",body:de},{id:"pipeline",group:"start",title:"流水线与顺利流程",keywords:"流程 阶段 顺序 发现 测试桩 运行 分类定级 语料库 工作流",body:ce},{id:"dashboard",group:"pipeline",title:"仪表盘",keywords:"工作台 概览 就绪度 报告 复现 审查 健康 指标",body:le},{id:"chat",group:"pipeline",title:"AI 助手（聊天）",keywords:"智能体 对话 工具 计划 自动 分支 回退 模型",body:ue},{id:"workflow",group:"pipeline",title:"模糊测试工作流",keywords:"折叠面板 连贯流程 单页 阶段",body:pe},{id:"discover",group:"pipeline",title:"发现目标",keywords:"扫描 候选项 排名 契合度评分 可达性 调用图 c cpp",body:he},{id:"harness",group:"pipeline",title:"生成测试桩",keywords:"起草 编译 冒烟 批准 promote 种子 引擎 语言 rust",body:ge},{id:"run",group:"pipeline",title:"运行模糊测试",keywords:"测试活动 引擎 时长 syzkaller 内核 边 执行数 停止 覆盖率",body:fe},{id:"triage",group:"pipeline",title:"分类定级崩溃",keywords:"casr 严重程度 去重 堆栈签名 缺陷报告 defectdojo 导出",body:me},{id:"corpus",group:"pipeline",title:"管理语料库",keywords:"种子 播种 扩充 精简 最小化 输入 ai 生成",body:be},{id:"projects",group:"library",title:"项目",keywords:"最近 添加 删除 移除 文件夹 工作区",body:ye},{id:"artifacts",group:"library",title:"构件",keywords:"崩溃 语料库 输入 浏览 导出 清除",body:ze},{id:"reports",group:"library",title:"报告",keywords:"撰写 markdown html pdf docx 导出 预览",body:ve},{id:"runs",group:"library",title:"运行历史",keywords:"趋势 对比 覆盖率曲线 自动回退 回归 测试桩修订版本",body:we},{id:"audit",group:"library",title:"策略审计",keywords:"自动回退 事件 时间线 已回退 已标记",body:ke},{id:"agents",group:"library",title:"智能体",keywords:"角色 工具 技能 系统提示词 自主性 自定义 内置",body:Se},{id:"skills",group:"library",title:"技能",keywords:"操作手册 领域 内置 自定义 root.md",body:Ee},{id:"knowledge",group:"library",title:"知识库",keywords:"bm25 搜索 索引 摄取 文档 pdf 已学习",body:Ce},{id:"automation",group:"library",title:"自动化",keywords:"调度 测试活动 cron 间隔 无头 已批准 并发 预算",body:xe},{id:"defectdojo",group:"library",title:"DefectDojo",keywords:"漏洞管理 发现 嵌入 推送 集成",body:Re},{id:"settings",group:"config",title:"设置",keywords:"提供方 运行时 引擎 安全护栏 存储 集成 问题跟踪器 表单 原始 toml",body:Ae},{id:"shortcuts",group:"reference",title:"键盘快捷键",keywords:"热键 命令面板 cmd k ctrl",body:De},{id:"troubleshooting",group:"reference",title:"疑难解答",keywords:"错误 问题 docker 提供方 关卡 消息 修复 帮助",body:je},{id:"cli",group:"reference",title:"命令行等价物",keywords:"cli 终端 hobot-fuzz 命令 serve tui",body:Te},{id:"glossary",group:"reference",title:"术语表",keywords:"定义 术语 词汇 含义",body:Ie}],f="https://github.com/hobot/hobot_fuzz",Le="https://github.com/hobot/hobot_fuzz/blob/main/docs/guides/GETTING_STARTED.md";function Pe(s,a){if(!a)return!0;const o=`${s.title} ${s.keywords??""} ${s.body}`.toLowerCase();return a.toLowerCase().split(/\s+/).filter(Boolean).every(n=>o.includes(n))}function Oe(){const{locale:s}=k(),a=s==="zh",o=(t,r)=>a?r:t,n=a?_e:se,m=a?ne:I,[i,b]=u.useState(""),[y,z]=u.useState(n[0].id),c=u.useMemo(()=>n.filter(t=>Pe(t,i)),[n,i]),l=c.find(t=>t.id===y)??c[0]??null,h=m.map(t=>({...t,sections:c.filter(r=>r.group===t.id)})).filter(t=>t.sections.length>0);return e.jsxs("div",{className:"flex flex-col gap-4",style:{animation:"fadeIn 0.2s ease"},children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsx(S,{title:o("Help & Documentation","帮助与文档"),description:o("How to use the hobot_fuzz desktop app, screen by screen. Everything here works offline.","如何逐屏使用 hobot_fuzz 桌面应用。此处内容均可离线查看。")}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs(g,{variant:"outline",size:"sm",onClick:()=>{p(Le)},title:o("Open the getting-started guide","打开入门指南"),children:[e.jsx(E,{size:14})," ",o("Getting Started","入门")]}),e.jsxs(g,{variant:"outline",size:"sm",onClick:()=>{p(f)},title:o("Open the GitHub repository","打开 GitHub 仓库"),children:[e.jsx(C,{size:14})," GitHub"]})]})]}),e.jsxs("div",{className:"flex gap-4 min-w-0",style:{alignItems:"flex-start"},children:[e.jsxs("nav",{className:"surface-card flex flex-col gap-2 shrink-0",style:{width:260,padding:"var(--space-md)",position:"sticky",top:0,maxHeight:"calc(100vh - 160px)",overflow:"auto"},"aria-label":o("Documentation sections","文档章节"),children:[e.jsxs("div",{className:"flex items-center gap-2 rounded-md",style:{padding:"6px 8px",background:"var(--surface-secondary)",border:"1px solid var(--border)"},children:[e.jsx(x,{size:14,className:"text-text-muted shrink-0"}),e.jsx("input",{value:i,onChange:t=>b(t.target.value),placeholder:o("Search the docs...","搜索文档…"),className:"flex-1 bg-transparent outline-none text-sm text-text-primary min-w-0",style:{border:"none"},"aria-label":o("Search documentation","搜索文档")})]}),h.length===0?e.jsx("p",{className:"text-xs text-text-muted",style:{padding:"8px 4px"},children:o(`No topics match "${i}".`,`没有匹配“${i}”的主题。`)}):h.map(t=>e.jsxs("div",{className:"flex flex-col gap-0.5",children:[e.jsx("span",{className:"text-xs font-semibold uppercase",style:{color:"var(--text-muted)",letterSpacing:"0.08em",padding:"8px 6px 2px"},children:t.title}),t.sections.map(r=>{const d=l?.id===r.id;return e.jsx("button",{onClick:()=>z(r.id),className:`text-left rounded-md transition-colors ${d?"bg-surface-active text-text-primary":"bg-transparent text-text-secondary hover:bg-surface-hover hover:text-text-primary"}`,style:{padding:"6px 8px",fontSize:13,border:"none",cursor:"pointer"},"aria-current":d?"page":void 0,children:r.title},r.id)})]},t.id))]}),e.jsxs("section",{className:"surface-card markdown-body flex-1 min-w-0",style:{padding:"var(--space-lg)",minHeight:400},children:[l?e.jsx(A,{remarkPlugins:[D],components:{code({className:t,children:r,...d}){const{lang:v,text:w}=j(t,r);return v==="mermaid"?e.jsx(T,{code:w}):e.jsx("code",{className:typeof t=="string"?t:void 0,...d,children:r})}},children:l.body}):e.jsx("p",{className:"text-sm text-text-muted",children:o("Select a topic to read it here.","选择一个主题以在此阅读。")}),e.jsxs("div",{className:"flex items-center gap-3 mt-6 pt-4",style:{borderTop:"1px solid var(--border)"},children:[e.jsx(R,{size:14,className:"text-text-muted"}),e.jsxs("span",{className:"text-xs text-text-muted",children:[o("Looking for the deep-dive design docs? See the ","想查看深入的设计文档？请访问"),e.jsx("button",{onClick:()=>{p(f)},style:{background:"none",border:"none",padding:0,color:"var(--accent)",cursor:"pointer"},children:o("project repository","项目仓库")}),o(".","。")]})]})]})]})]})}export{Oe as HelpView};
