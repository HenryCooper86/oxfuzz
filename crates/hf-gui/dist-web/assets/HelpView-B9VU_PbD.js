import{u as k,r as u,j as e,V as x,B as g,L as S,o as p,G as E,S as C,d as R,e as A,P as f}from"./index-BgNSkr3c.js";import{M as D,r as j,c as T,a as I}from"./reportPreviewCode-DQERGNVF.js";const P=[{id:"start",title:"Getting Started"},{id:"pipeline",title:"The Fuzzing Pipeline"},{id:"library",title:"Library & Resources"},{id:"config",title:"Configuration"},{id:"reference",title:"Reference"}],L=`
# Welcome to oxfuzz
...
`,Oe=[{id:"welcome",group:"start",title:"欢迎与安全模型",keywords:"简介 概述 什么是模糊测试 安全 沙箱 人工介入 hitl",body:ce},{id:"first-run",group:"start",title:"首次运行与设置",keywords:"向导 提供方 api 密钥 docker 安装 引导 快速开始",body:le},{id:"pipeline",group:"start",title:"流水线与顺利流程",keywords:"流程 阶段 顺序 发现 测试桩 运行 分类定级 语料库 工作流",body:ue},{id:"dashboard",group:"pipeline",title:"仪表盘",keywords:"工作台 概览 就绪度 报告 复现 审查 健康 指标",body:pe},{id:"chat",group:"pipeline",title:"AI 助手（聊天）",keywords:"智能体 对话 工具 计划 自动 分支 回退 模型",body:he},{id:"workflow",group:"pipeline",title:"模糊测试工作流",keywords:"折叠面板 连贯流程 单页 阶段",body:ge},{id:"discover",group:"pipeline",title:"发现目标",keywords:"扫描 候选项 排名 契合度评分 可达性 调用图 c cpp",body:fe},{id:"harness",group:"pipeline",title:"生成测试桩",keywords:"起草 编译 冒烟 批准 promote 种子 引擎 语言 rust",body:me},{id:"run",group:"pipeline",title:"运行模糊测试",keywords:"测试活动 引擎 时长 syzkaller 内核 边 执行数 停止 覆盖率",body:ye},{id:"triage",group:"pipeline",title:"分类定级崩溃",keywords:"casr 严重程度 去重 堆栈签名 缺陷报告 defectdojo 导出",body:be},{id:"corpus",group:"pipeline",title:"管理语料库",keywords:"种子 播种 扩充 精简 最小化 输入 ai 生成",body:ve},{id:"projects",group:"library",title:"项目",keywords:"最近 添加 删除 移除 文件夹 工作区",body:ze},{id:"artifacts",group:"library",title:"构件",keywords:"崩溃 语料库 输入 浏览 导出 清除",body:we},{id:"reports",group:"library",title:"报告",keywords:"撰写 markdown html pdf docx 导出 预览",body:ke},{id:"runs",group:"library",title:"运行历史",keywords:"趋势 对比 覆盖率曲线 自动回退 回归 测试桩修订版本",body:xe},{id:"audit",group:"library",title:"策略审计",keywords:"自动回退 事件 时间线 已回退 已标记",body:Se},{id:"agents",group:"library",title:"智能体",keywords:"角色 工具 技能 系统提示词 自主性 自定义 内置",body:Ee},{id:"skills",group:"library",title:"技能",keywords:"操作手册 领域 内置 自定义 root.md",body:Ce},{id:"knowledge",group:"library",title:"知识库",keywords:"bm25 搜索 索引 摄取 文档 pdf 已学习",body:Re},{id:"automation",group:"library",title:"自动化",keywords:"调度 测试活动 cron 间隔 无头 已批准 并发 预算",body:Ae},{id:"automotive",group:"library",title:"汽车协议",keywords:"can uds pcap 离线 vcan 回放 sidecar 物理台架 策略 证据 ai 活动 报告 导出 状态",body:De},{id:"defectdojo",group:"library",title:"DefectDojo",keywords:"漏洞管理 发现 嵌入 推送 集成",body:je},{id:"settings",group:"config",title:"设置",keywords:"提供方 模糊测试 汽车协议 沙箱 引擎 存储 集成 问题跟踪器 表单 原始 toml",body:Te},{id:"shortcuts",group:"reference",title:"键盘快捷键",keywords:"热键 命令面板 cmd k ctrl",body:Ie},{id:"troubleshooting",group:"reference",title:"疑难解答",keywords:"错误 问题 docker 提供方 关卡 消息 修复 帮助",body:Pe},{id:"cli",group:"reference",title:"命令行等价物",keywords:"cli 终端 oxfuzz 命令 serve tui",body:Le},{id:"glossary",group:"reference",title:"术语表",keywords:"定义 术语 词汇 含义",body:Ne}];function _e(s,r){if(!r)return!0;const a=`${s.title} ${s.keywords??""} ${s.body}`.toLowerCase();return r.toLowerCase().split(/\s+/).filter(Boolean).every(n=>a.includes(n))}function Me(){const{locale:s}=k(),r=s==="zh",a=(t,o)=>r?o:t,n=r?Oe:ie,m=r?de:P,[i,y]=u.useState(""),[b,v]=u.useState(n[0].id),c=u.useMemo(()=>n.filter(t=>_e(t,i)),[n,i]),l=c.find(t=>t.id===b)??c[0]??null,h=m.map(t=>({...t,sections:c.filter(o=>o.group===t.id)})).filter(t=>t.sections.length>0);return e.jsxs("div",{className:"flex flex-col gap-4",style:{animation:"fadeIn 0.2s ease"},children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsx(x,{title:a("Help & Documentation","帮助与文档"),description:a("How to use the oxfuzz desktop app, screen by screen. Everything here works offline.","如何逐屏使用 oxfuzz 桌面应用。此处内容均可离线查看。")}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs(g,{variant:"outline",size:"sm",onClick:()=>{p(A)},title:a("Open the getting-started guide","打开入门指南"),children:[e.jsx(S,{size:14})," ",a("Getting Started","入门")]}),e.jsxs(g,{variant:"outline",size:"sm",onClick:()=>{p(f)},title:a("Open the GitLab repository","打开 GitLab 仓库"),children:[e.jsx(E,{size:14})," GitLab"]})]})]}),e.jsxs("div",{className:"flex gap-4 min-w-0",style:{alignItems:"flex-start"},children:[e.jsxs("nav",{className:"surface-card flex flex-col gap-2 shrink-0",style:{width:260,padding:"var(--space-md)",position:"sticky",top:0,maxHeight:"calc(100vh - 160px)",overflow:"auto"},"aria-label":a("Documentation sections","文档章节"),children:[e.jsxs("div",{className:"flex items-center gap-2 rounded-md",style:{padding:"6px 8px",background:"var(--surface-secondary)",border:"1px solid var(--border)"},children:[e.jsx(C,{size:14,className:"text-text-muted shrink-0"}),e.jsx("input",{value:i,onChange:t=>y(t.target.value),placeholder:a("Search the docs...","搜索文档…"),className:"flex-1 bg-transparent outline-none text-sm text-text-primary min-w-0",style:{border:"none"},"aria-label":a("Search documentation","搜索文档")})]}),h.length===0?e.jsx("p",{className:"text-xs text-text-muted",style:{padding:"8px 4px"},children:a(`No topics match "${i}".`,`没有匹配“${i}”的主题。`)}):h.map(t=>e.jsxs("div",{className:"flex flex-col gap-0.5",children:[e.jsx("span",{className:"text-xs font-semibold uppercase",style:{color:"var(--text-muted)",letterSpacing:"0.08em",padding:"8px 6px 2px"},children:t.title}),t.sections.map(o=>{const d=l?.id===o.id;return e.jsx("button",{onClick:()=>v(o.id),className:`text-left rounded-md transition-colors ${d?"bg-surface-active text-text-primary":"bg-transparent text-text-secondary hover:bg-surface-hover hover:text-text-primary"}`,style:{padding:"6px 8px",fontSize:13,border:"none",cursor:"pointer"},"aria-current":d?"page":void 0,children:o.title},o.id)})]},t.id))]}),e.jsxs("section",{className:"surface-card markdown-body flex-1 min-w-0",style:{padding:"var(--space-lg)",minHeight:400},children:[l?e.jsx(D,{remarkPlugins:[j],components:{code({className:t,children:o,...d}){const{lang:z,text:w}=T(t,o);return z==="mermaid"?e.jsx(I,{code:w}):e.jsx("code",{className:typeof t=="string"?t:void 0,...d,children:o})}},children:l.body}):e.jsx("p",{className:"text-sm text-text-muted",children:a("Select a topic to read it here.","选择一个主题以在此阅读。")}),e.jsxs("div",{className:"flex items-center gap-3 mt-6 pt-4",style:{borderTop:"1px solid var(--border)"},children:[e.jsx(R,{size:14,className:"text-text-muted"}),e.jsxs("span",{className:"text-xs text-text-muted",children:[a("Looking for the deep-dive design docs? See the ","想查看深入的设计文档？请访问"),e.jsx("button",{onClick:()=>{p(f)},style:{background:"none",border:"none",padding:0,color:"var(--accent)",cursor:"pointer"},children:a("project repository","项目仓库")}),a(".","。")]})]})]})]})]})}export{Me as HelpView};
