...
use hf_core::hook::{ChainType, Middleware, MiddlewareContext, MiddlewareResult};
...
impl MiddlewareChain {
    ...
    ) -> Result<(), hf_core::hook::MiddlewareError> {
...
mod tests {
    ...
    impl Middleware for TestMiddleware {
        async fn execute(
            &self,
            ctx: &mut MiddlewareContext,
        ) -> Result<MiddlewareResult, hf_core::hook::MiddlewareError> {
