...
use crash_inputs::{
    ...
    is_regular_file, stage_crash_inputs,
};
use guards::{
...
use harness_workspace::{
    ...
    sanitize_target, write_current_harness_binary, write_current_harness_id,
...
use uuid::Uuid;
use workspace::{
    clear_managed_workspace_root, configured_workspace_root, document_staging_dir,
    prepare_configured_workspace_root, prepare_managed_workspace_root_with_adoption,
    resolve_workspace_directory, run_output_relative, workspace_lock_error, workspace_lock_file,
...
#[cfg(test)]
mod workspace_tests {
    use super::{output_budget_status, OutputBudget};
