...
use crate::exec::{CommandRunner, RuntimeCapability};
...
///
/// Implementations handle the business logic of the tool and nothing else. A
/// tool grants itself no permission and enforces none: authorization happens
